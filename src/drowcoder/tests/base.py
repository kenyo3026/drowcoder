...
This ensures consistent report generation across all agent tests.
"""
...
def generate_report_name(test_name: str, commit_sha: Optional[str], is_dirty: bool, extension: str = 'log') -> str:
    ...
    Examples:
        - Clean repo: report_agent_tool_call_pruning_0ada4013.log
        - Dirty repo: report_agent_tool_call_pruning_0ada4013_dirty.log
        - No git: report_agent_tool_call_pruning.log
    """
    if commit_sha:
...
def run_tests_with_report(test_file: str, test_name: str) -> int:
    ...
    Args:
        ...
        test_name: Name of the test being run (e.g., 'agent_tool_call_pruning')
